...
<div style="background-color: #E9F2FC; padding: 10px; border-radius: 5px;">
    <span style="font-size: 14px; color: #000000;">ℹ️<b>Cosa significa la soglia?</b></span><br>
    <span style="font-size: 12px; color: #004280;">La soglia che imposti indica che l'analisi si concentrerà solo sulle query o parole chiave che generano la percentuale impostata del totale delle prestazioni. 
